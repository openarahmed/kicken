    ...
    <section className="relative w-full overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-[20px] md:px-[32px] lg:px-[64px] pt-[56px] md:pt-[80px] lg:pt-[128px] flex flex-col lg:flex-row items-center lg:items-end justify-between gap-[40px]">
        ...
        <div 
          ...
          data-aos="fade-right"
        >
          {/* Tagline Update: More Professional */}
          <div className="flex items-center gap-3 mb-6 text-blue-400">
            <span className="w-12 h-[2px] bg-blue-400"></span>
            <span className="uppercase tracking-widest font-bold text-sm">The Academy Philosophy</span>
          </div>

          <FaQuoteLeft className="text-4xl text-gray-600 mb-6 opacity-50" />

          {/* Headline Update: More Impactful */}
          <h1 className="font-extrabold leading-[1.1] mb-[32px] text-[32px] md:text-[48px] lg:text-[64px]">
            You Can&apos;t Reach The <span className="text-blue-400 italic">Top</span> Unless <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-white">
              You Embrace The Struggle
            </span>
          </h1>

          {/* Author Info Update: Positioned as an Authority */}
          <div className="border-l-4 border-blue-500 pl-6">
            <h4 className="text-xl font-bold text-white">Marcus Sterling</h4>
            <p className="text-gray-400 text-sm uppercase tracking-wide">Head of Youth Development, Kicken</p>
          </div>
        </div>
        ...
        >
          ...
          <div className="relative w-[300px] h-[400px] md:w-[450px] md:h-[550px]">
            <Image
              ...
              alt="Elite Professional Footballer Training"
              fill
